...
module alu(input signed [31:0]SrcA, input signed [31:0]SrcB , input signed [31:0]SrcC, input [4:0] alucontrol ,input rst , input branch,input [1:0]mode, output reg signed [31:0]Result , output zero);
    ...
    begin
      if(rst==1)
       ...
       endcase
          ...
          else if(mode == 2'b10)      //R2 TYPE
       begin
       case(alucontrol)
         5'b00000 :  Result = -SrcA ; //neg      	
         5'b00001 : Result = (SrcA < 0) ? -SrcA : SrcA ; // ABS
//         5'b00010 :  Result = SrcA | SrcB   //or
//       	5'b00011;  Result = SrcA & SrcB  //and
//          5'b00100;  Result = ~(SrcA & SrcB ); //nand
//          5'b00101;  Result = ~(SrcA | SrcB ); //nor
       ...
       endcase
              ...
              case(alucontrol)					//I TYPE
            	 ...
            	 //7'b0100_000 :control <= 00000; //deci
              	  ...
              	  5'b10011: Result = SrcA >>> SrcC[4:0];  //srai
